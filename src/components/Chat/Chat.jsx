    ...
    <>
      {!!chatConfig && (
        <ChatEngine
          ...
          // when you create a chat it gets selected by default
          // sort chats so they always remain in the same order
          // when a chat gets deleted refresh the chats
        ...
        />
        // if a chat is selected display that chat or
