...
export const ChatInput = () => {
  ...
  // only accepts jpegs and png for uploads
  // only render image upload if user clicked on upload icon
  // files is an array that only accepts the selected image
  // after image is sent close the upload screen
  return (
    <>
