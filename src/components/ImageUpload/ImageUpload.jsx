...
export const ImageUpload = ({
  ...
  // crop if avatar else it is an image, just render out the image
  // can cancel upload or submit upload on click
  // on click if crop convert image to string
  return (
