...
export const RailHeader = () => {
  ...
  // allows user to choose their avatar
  // uploads the string from the upload ref to firebase
  // this is done by sending the download url to fb
  // update users avatar to the url and then set image to null in state
  //
  return (
    <>
      <input
