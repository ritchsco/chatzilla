...
export const ChatList = () => {
    ...
    // if chatid = selected chat, allow to select chat
    // 1 user in chat = No one added yet
    // 2 users = display user username and display last 50 chars sent
    // as well as display message, if its an attachment display un sent an attachment
    // final case = group chat 
    // add option to delete chat, verify user wants to delete this chat
return (    
